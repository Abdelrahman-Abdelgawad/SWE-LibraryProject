...
class BookWindow(Window):
    ...
    def __init__(self):
        self._backEnd.setTableName("book")
    ...
    * returns:     void
    ...
    def ExecuteGUI(self):
        ...
        root.title("Library books' records")
        ...
        self.CurrentRow["ISBN"]    = StringVar()
        self.CurrentRow["Title"]     = StringVar()
        self.CurrentRow["Author"] = StringVar()
        self.CurrentRow["Publisher"]    = StringVar()
        self.CurrentRow["NumOfCopies"]  = StringVar()
        self.CurrentRow["LatencyFinePerDay"] = StringVar()
        ...
        self.trv.heading(1, text="ISBN")
        self.trv.heading(2, text="Title")
        self.trv.heading(3, text="Author")
        self.trv.heading(4, text="Publisher")
        self.trv.heading(5, text="Number of Copies")
        self.trv.heading(6, text="LatencyFine/Day")
        ...
        lbl1 = Label(wrapper3, text="ISBN: ", font=("Berlin Sans FB Demi",16),bg="#cdcdcd")
        lbl1.grid ( row=0, column=0, padx=5, pady=3)
        
        ent1= Entry(wrapper3, textvariable = self.CurrentRow["ISBN"] ,font=("PT Bold Heading",16))
        ent1.grid(row=0, column=1, padx=5, pady=3)
        
        lbl2 = Label(wrapper3, text="Title: " ,font=("Berlin Sans FB Demi",16),bg="#cdcdcd")
        lbl2.grid(row=0, column=3, padx=5, pady=3)
        
        ent2 = Entry(wrapper3, textvariable = self.CurrentRow["Title"],font=("PT Bold Heading",16))
        ent2.grid(row=0, column=4, padx=5, pady=3)
        
        lbl3 = Label(wrapper3, text="Author: " ,font=("Berlin Sans FB Demi",16),bg="#cdcdcd")
        lbl3.grid(row=1, column =0, padx=5, pady=3)
        
        ent3 = Entry(wrapper3, textvariable = self.CurrentRow["Author"], font=("PT Bold Heading",16))
        ent3.grid(row=1, column=1, padx=5, pady=3)
        
        lbl4 = Label(wrapper3, text="Publisher: ",font=("Berlin Sans FB Demi",16),bg="#cdcdcd")
        lbl4.grid(row=1, column =3, padx=5, pady=3)
        
        ent4 = Entry(wrapper3, textvariable = self.CurrentRow["Publisher"], font=("PT Bold Heading",16))
        ent4.grid(row=1, column=4, padx=5, pady=3)
        
        
        lbl5 = Label(wrapper3, text="Number of Copies: ",font=("Berlin Sans FB Demi",16),bg="#cdcdcd")
        lbl5.grid(row=2, column =0, padx=5, pady=3)
        
        ent5 = Entry(wrapper3, textvariable = self.CurrentRow["NumOfCopies"], font=("PT Bold Heading",16))
        ent5.grid(row=2, column=1, padx=5, pady=3)
        
        
        lbl6 = Label(wrapper3, text="LatencyFinePerDay: ",font=("Berlin Sans FB Demi",16),bg="#cdcdcd")
        lbl6.grid(row=2, column =3, padx=5, pady=3)
        
        ent6 = Entry(wrapper3, textvariable = self.CurrentRow["LatencyFinePerDay"], font=("PT Bold Heading",16))
