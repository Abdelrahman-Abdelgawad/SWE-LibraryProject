...
class BorrowingWindow(Window):
    
    def __init__(self):
        self._backEnd.setTableName("borrowing")
    ...
    * returns:     void
    ...
    def ExecuteGUI(self):
        ...
        root.title("Library borrowing's records")
        ...
        self.CurrentRow["BorrowID"]      = StringVar()
        self.CurrentRow["BookISBN"]      = StringVar()
        self.CurrentRow["MemID"]         = StringVar()
        self.CurrentRow["BorrowingDate"] = StringVar()
        ...
        self.trv.heading(1, text="Borrowing ID")
        self.trv.heading(2, text="Book ISBN")
        self.trv.heading(3, text="Member ID")
        self.trv.heading(4, text="Borrowing Date")
        ...
        lbl1 = Label(wrapper3, text="Borrowing ID: ", font=("Berlin Sans FB Demi",16),bg="#cdcdcd")
        lbl1.grid ( row=0, column=0, padx=5, pady=3)
        
        ent1= Entry(wrapper3, textvariable = self.CurrentRow["BorrowID"] ,font=("PT Bold Heading",16))
        ...
        lbl4 = Label(wrapper3, text="Borrowing Date: ",font=("Berlin Sans FB Demi",16),bg="#cdcdcd")
        lbl4.grid(row=3, column =0, padx=5, pady=3)
        
        ent4 = Entry(wrapper3, textvariable = self.CurrentRow["BorrowingDate"], font=("PT Bold Heading",16))
