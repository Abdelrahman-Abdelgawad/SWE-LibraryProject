...
class EmployeeWindow(Window):
    ...
    def __init__(self):
        self._backEnd.setTableName("employee")
    ...
    * returns:     void
    ...
    def ExecuteGUI(self):
        ...
        root.title("Library employees' records")
        ...
        self.CurrentRow["EmpID"]    = StringVar()
        self.CurrentRow["Name"]     = StringVar()
        self.CurrentRow["Salary"] = StringVar()
        ...
        self.trv.heading(1, text="Employee ID")
        self.trv.heading(2, text="Name")
        self.trv.heading(3, text="Salary")
        ...
        lbl1 = Label(wrapper3, text="Employee ID: ", font=("Berlin Sans FB Demi",16),bg="#cdcdcd")
        lbl1.grid ( row=0, column=0, padx=5, pady=3)
        
        ent1= Entry(wrapper3, textvariable = self.CurrentRow["EmpID"] ,font=("PT Bold Heading",16))
        ...
        lbl3 = Label(wrapper3, text="Salary: " ,font=("Berlin Sans FB Demi",16),bg="#cdcdcd")
        lbl3.grid(row=1, column =0, padx=5, pady=3)
        
        ent3 = Entry(wrapper3, textvariable = self.CurrentRow["Salary"], font=("PT Bold Heading",16))
        ...
        lbl5 = Label(wrapper3, text="Phone Number: ",font=("Berlin Sans FB Demi",16),bg="#cdcdcd")
        lbl5.grid(row=2, column =0, padx=5, pady=3)
        
        ent5 = Entry(wrapper3, textvariable = self.CurrentRow["PhoneNum"], font=("PT Bold Heading",16))
